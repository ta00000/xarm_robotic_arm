...
if("TRUE" STREQUAL "TRUE")
  set(camera_demo_SOURCE_PREFIX /home/tbs/xarm/src/xarm_ros/xarm_vision/camera_demo)
  set(camera_demo_DEVEL_PREFIX /home/tbs/xarm/devel)
  ...
  set(camera_demo_INSTALL_PREFIX /home/tbs/xarm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tbs/xarm/src/xarm_ros/xarm_vision/camera_demo/${idir}'.  ${_report}")
    endif()
