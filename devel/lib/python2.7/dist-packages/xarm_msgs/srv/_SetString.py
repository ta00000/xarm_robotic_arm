...
"""autogenerated by genpy from xarm_msgs/SetStringRequest.msg. Do not edit."""
import codecs
import sys
...
class SetStringRequest(genpy.Message):
  _md5sum = "71b1f2382dc64280861b19494c3b7442"
  _type = "xarm_msgs/SetStringRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.str_data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.str_data = str[start:end]
      start = end
      end += 4
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from xarm_msgs/SetStringResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetStringResponse(genpy.Message):
  ...
  _type = "xarm_msgs/SetStringResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
...
class SetString(object):
  _type          = 'xarm_msgs/SetString'
  _md5sum = '8ef44a329258a19c2b77a7a598761c55'
